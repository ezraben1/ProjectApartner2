import {Container,Flex,Spacer,Link,Heading,Button,Menu,MenuButton,MenuList,MenuItem,useMediaQuery,} from "@chakra-ui/react";
        ...
        <Flex justify="space-between" alignItems="center" py="2">
          ...
          {isSmallerThanLg ? (
            <Menu>
              ...
              <MenuList>
                <MenuItem as={RouterLink} to="/core">
                  Core
                </MenuItem>
            ...
            <Flex alignItems="center">
              ...
              {username ? (
                ...
                <>
                  <Button colorScheme="blue" ml="30" as={RouterLink} to="/login">
                    Login
                  </Button>
                  <Button colorScheme="blue" ml="40" as={RouterLink} to="/signup">
                    Sign Up!
                  </Button>
                </>
              )}
...
const NavLinks = () => (
  <Flex as="nav" alignItems="center" justifyContent="space-between" w="100%">
    ...
    <Menu>
      <MenuButton as={Button} color="black" fontWeight="medium" mr="4" _hover={{ textDecoration: "none" }}>
        <Flex alignItems="center">
          <RouterLink to="/owner" style={{ textDecoration: "none", color: "black" }}>
            Owner
          </RouterLink>
    ...
    <Menu>
      <MenuButton as={Button} color="black" fontWeight="medium" mr="4" _hover={{ textDecoration: "none" }}>
        <Flex alignItems="center">
          <RouterLink to="/Searcher" style={{ textDecoration: "none", color: "black" }}>
            Searcher
          </RouterLink>
          <ChevronRightIcon ml="1" />
        </Flex>
    ...
    <Menu>
      <MenuButton as={Button} color="black" fontWeight="medium" mr="4" _hover={{ textDecoration: "none" }}>
        <Flex alignItems="center">
          <RouterLink to="/Renter" style={{ textDecoration: "none", color: "black" }}>
            Renter
          </RouterLink>
          <ChevronRightIcon ml="1" />
        </Flex>
